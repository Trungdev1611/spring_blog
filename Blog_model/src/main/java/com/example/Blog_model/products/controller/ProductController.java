...
public class ProductController {
    ...
    ResponseEntity<List<ProductDTO>> getListProduct(@PathVariable Long idStore) {
        ...
        List<ProductDTO> response = productImpl.getListProductByStoreId(idStore);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @GetMapping("/products")
    ResponseEntity<List<ProductDTO>> getListProductAllStore() {

        List<ProductDTO> response = productImpl.getListProductAllStore();
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    ResponseEntity<ProductDTO> getListProductFromOneStore(@PathVariable Long idProduct, @PathVariable Long idStore) {
